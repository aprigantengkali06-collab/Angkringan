...
const printDayPDF = (date, orders, expenses, kasirs, menus=[]) => {
  ...
  const modalMitra = getOrdersMitraModal(paid, menus);
...
const printMonthPDF = (monthKey, monthLabel, orders, expenses, kasirs, menus=[]) => {
  ...
  const dayMap = {};
  paid.forEach(o=>{const d=orderSessionDate(o);if(!d) return; if(!dayMap[d])dayMap[d]={pemasukan:0,pengeluaran:0,modalMitra:0,orders:[]};dayMap[d].pemasukan+=o.total;dayMap[d].modalMitra+=getOrderMitraModal(o, menus);dayMap[d].orders.push(o);});
...
// Level 3: Detail Hari
const DayDetail = ({date, orders, expenses, kasirs, menus, onBack, businessDate}) => {
