...
// Level 3: Detail Hari
const DayDetail = ({date, orders, expenses, setExpenses, kasirs, menus, onBack, businessDate, baseSummary}) => {
...
const POS = ({menus,orders,setOrders,user,businessDate,currentSessionId,kasirs,setScreen,posStep:step,setPosStep:setStep,posName:name,setPosName:setName,posCart:cart,setPosCart:setCart,receiptSettings}) => {
  ...
  if(step==="menu")return(<div className="pos-menu-screen" style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"}}>
    <div style={{padding:"11px 18px 9px",borderBottom:"1px solid var(--border)",flexShrink:0}}>
      ...
      {!showSearch&&<CatBar val={cat} set={setCat} categories={getCategoryOptions(menus)}/>}
    </div>
  ...
  if(sel&&ord)return(<div className="tagihan-detail-screen" style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
    ...
    {adding?(
      <><div style={{padding:"10px 18px",borderBottom:"1px solid var(--border)",flexShrink:0}}>
        ...
        <CatBar val={cat} set={setCat} categories={getCategoryOptions(menus)}/>
      </div>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"17px",display:"flex",flexDirection:"column",gap:13}}>
        ...
        <Btn v="ghost" onClick={()=>printStruk(ord,0,kasirs,receiptSettings,"nanti")} full>🧾 Cetak Struk Tagihan</Btn>
      </div>
    )}
...
const MenuMgmt = ({menus,setMenus,mitras,onClose}) => {
  ...
  return(<div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"}}>
    ...
    <div style={{padding:"9px 18px",borderBottom:"1px solid var(--border)",flexShrink:0}}><CatBar val={cat} set={setCat} categories={getCategoryOptions(menus)}/></div>
