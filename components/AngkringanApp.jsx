  ...
  <style>{`
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    @media (min-width: 960px) and (orientation: landscape){
      .app-shell{max-width:min(1440px,calc(100vw - 36px));height:calc(100vh - 24px);margin:12px auto;border-radius:30px;border:1px solid rgba(148,163,184,0.28);box-shadow:0 28px 80px rgba(15,23,42,0.22)}
      .app-frame{grid-template-columns:112px minmax(0,1fr);grid-template-rows:auto minmax(0,1fr);grid-template-areas:"nav header" "nav content"}
      .nav-shell{display:flex !important;flex-direction:column !important;justify-content:flex-start;padding:22px 10px !important;gap:10px;border-top:none !important;border-right:1px solid var(--border);background:linear-gradient(180deg,rgba(15,23,42,0.97) 0%,rgba(30,41,59,0.95) 100%) !important}
      .nav-brand{display:flex !important;align-items:center;justify-content:center;padding-bottom:6px}
      .nav-btn{width:100%;min-height:68px !important;padding:14px 10px !important;border-radius:18px;justify-content:center}
