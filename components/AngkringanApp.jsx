  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:12}}>
      ...
      <div style={{background:"var(--card2)",border:"1px dashed var(--border)",borderRadius:12,padding:"10px 12px"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:8,alignItems:"center",paddingTop:7,paddingBottom:7,borderBottom:"1px solid rgba(215,226,240,0.8)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:8,alignItems:"center",paddingTop:7}}>
          <p style={{color:"var(--muted)",fontSize:10,fontWeight:600}}>Build</p>
          <p className="sora" style={{color:"var(--amber)",fontWeight:700,fontSize:12}}>v8-sync</p>
        </div>
      </div>
  ...
  return(
    <div className="dashboard-scroll" style={{flex:1,overflowY:"auto",padding:"12px 16px 10px"}}>
      <div style={{marginBottom:12}}>
        ...
        <p style={{color:"var(--amber)",fontSize:10,fontWeight:700,marginTop:4}}>Build v8-sync</p>
      </div>
